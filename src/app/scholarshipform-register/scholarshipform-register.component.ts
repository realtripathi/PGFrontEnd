...
export class ScholarshipformRegisterComponent implements OnInit {
  ...
  schemes: any[] = [
    { schemeId: "1001", name: "Merit-cum-Means based", details: "The Maharashtra DTE Scholarship gives the opportunity to the students belonging to the backwards categories to study in the government and private colleges after completion of their Class 12th. The candidates applying for the Maharashtra Merit cum Means Scholarship must have completed 10th and 12th from a recognized board with a minimum of 60% marks in aggregate. The applicant must produce all the documents prescribed by the state." },
    { schemeId: "1002", name: "PRAGATI SCHOLARSHIP ", details: "The scholarship is applicable to One Girl per family and it can be extended for Two Girl Child per family where the family income is less than Rs. 8 Lakh /annum (In case of married girl child, the income of parents/ in laws whichever is higher is to be considered).  Amount of scholarship: Tuition Fee of Rs. 30,000/-. " },
    { schemeId: "1003", name: "NTSE (National Talent Search Examination)", details: "Candidate must be an Indian citizen. A minimum of 60% marks Class IX is required. SC, ST and PH candidates will need 55% marks in Class IX. Candidate must be studying in a recognized school in their respective State. " },
  ];
